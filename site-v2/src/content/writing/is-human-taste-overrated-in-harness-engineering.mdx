...
import ScientificEnvironmentExplorer from '../../components/figures/ScientificEnvironmentExplorer.astro';
import SmddTaskNavigator from '../../components/figures/SmddTaskNavigator.astro';
