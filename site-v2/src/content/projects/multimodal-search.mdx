...
image: ../../assets/images/projects/analyses.png
importance: 3
...
links:
  - label: Code
    ...
    href: https://github.com/R-Suresh07/Image-Search-using-GPT-4-Vision-API
  - label: Write-up
    text: Medium Article
    href: https://medium.com/@sureshraghu0706/revolutionizing-image-search-with-gpt-4-vision-e1fc36fca7e8
---
