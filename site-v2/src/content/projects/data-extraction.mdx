...
image: ../../assets/images/projects/data_extraction.png
importance: 2
...
links:
  - label: Code
    ...
    href: https://github.com/R-Suresh07/Information-Extraction-from-Images
  - label: Write-up
    text: Medium Article
    href: https://medium.com/@sureshraghu0706/from-images-to-insights-3-tiered-data-extraction-from-images-with-ocr-and-large-language-models-0c07754813cc
---
